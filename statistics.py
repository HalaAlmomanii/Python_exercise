...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  1 09:29:40 2019
...
im1=Image.open('taz.jpeg')
im2=Image.open('taz.jpeg').resize(im1.size)
im1.show()
...
draw.text((im1.size[0]/2-im1.size[0]/2,im1.size[1]/2+20),'Hala',fill=(225,225,0))
